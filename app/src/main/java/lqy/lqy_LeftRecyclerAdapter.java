...
import first.cc.meishitianxia.PageShicai;
...
public class lqy_LeftRecyclerAdapter extends RecyclerView.Adapter<lqy_LeftRecyclerAdapter.ViewHolder> {

    private PageShicai context;
    ...
    public lqy_LeftRecyclerAdapter(PageShicai context, List<String> bigSortList, RecyclerView recyclerView) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //填充Item中的布局
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.lqy_recyclerview_item_search_sort_left, parent, false);
        // 实例化viewholder
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        // 绑定数据
        holder.tvName1.setText(bigSortList.get(position));
        //item点击后背景的变化
        if (position == selectedPosition) {
            holder.tvName1.setBackgroundResource(R.color.color_107);
            holder.view1.setVisibility(View.VISIBLE);
            holder.tvName1.setTextColor(context.getResources().getColor(R.color.color_002));
        } else {
            holder.view1.setVisibility(View.GONE);
            holder.tvName1.setBackgroundResource(R.color.color_109);
            holder.tvName1.setTextColor(context.getResources().getColor(R.color.color_100));
        }
    }
    /**
     * 将选中项移动到中间位置的方法
    ...
    public  static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, final LeftListener listener) {
            super(itemView);
            tvName1 = (TextView) itemView.findViewById(R.id.tv_left1);
