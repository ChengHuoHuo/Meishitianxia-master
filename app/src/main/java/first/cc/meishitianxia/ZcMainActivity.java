...
public class ZcMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ZcMainActivity.this,"请长按此图标进行视频上传",Toast.LENGTH_LONG).show();
            }
        });
...
//                return true;
    ...
    public void update(MenuItem item){
        ...
        Intent intent =new Intent(ZcMainActivity.this, Zcupdate.class);
    ...
    private void download(BmobFile file) {
        ...
        file.download(new DownloadFileListener() {
            ...
            public void done(String path, BmobException e) {
                if(e==null)
                {
//                    Toast.makeText(ZcMainActivity.this,path,Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(ZcMainActivity.this, Zcplayvideo.class);
    ...
    public void playvideo1(View view) {
        ...
        Toast.makeText(ZcMainActivity.this,"请稍等，视频正在缓冲",Toast.LENGTH_SHORT).show();
    ...
    public void searchvideo(View view) {
        ...
        new AlertDialog.Builder(ZcMainActivity.this,R.style.Theme_AppCompat_Light_Dialog_Alert).setTitle("搜索视频")
...
//                        Intent intent=new Intent(ZcMainActivity.this,Zcsearchvideo.class);
//                        Bundle bundle=new Bundle();
...
//                if(e==null){
//                    Toast.makeText(ZcMainActivity.this,"Success",Toast.LENGTH_LONG).show();
//                }else{
//                    Toast.makeText(ZcMainActivity.this,e.getMessage(),Toast.LENGTH_LONG).show();
//                }
//            }
//        });
//    }
