...
import first.cc.meishitianxia.PageFenlei;
...
public class LeftRecyclerAdapter extends RecyclerView.Adapter<LeftRecyclerAdapter.ViewHolder> {
    private PageFenlei context;
    private List<String> bigSortList;
    private RecyclerView recyclerView;
    private LeftListener listener;
    private int selectedPosition;

    public LeftRecyclerAdapter(PageFenlei context, List<String> bigSortList, RecyclerView recyclerView) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //填充Item中的布局
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.xq_recyclerview_item_search_sort_left, parent, false);
        // 实例化viewholder
